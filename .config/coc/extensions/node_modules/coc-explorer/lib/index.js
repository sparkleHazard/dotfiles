...
async function displayWidth2(str) {
  return await import_coc17.workspace.nvim.call("strdisplaywidth", [str]);
}
  ...
  start(cmd, args, cwds, excludePatterns) {
    ...
    for (const cwd of cwds) {
      ...
      rl.on("line", (line) => {
        ...
        const location = import_coc54.Location.create(import_coc54.Uri.file(file).toString(), range);
        this.emit("data", {
          label: line,
          location
        });
